...
S:"ytp-mdx-popup-dialog",X:{role:"dialog"},V:[{I:"div",S:"ytp-mdx-popup-dialog-inner-content",V:[{I:"div",S:"ytp-mdx-popup-title",ya:"Kijelentkezt\u00e9l"},{I:"div",S:"ytp-mdx-popup-description",ya:"Az \u00e1ltalad megn\u00e9zett vide\u00f3k szerepelhetnek a TV-s megtekint\u00e9si el\u0151zm\u00e9nyeidben, \u00e9s befoly\u00e1solhatj\u00e1k a TV-s aj\u00e1nl\u00e1sokat. Ennek elker\u00fcl\u00e9se \u00e9rdek\u00e9ben vond vissza, \u00e9s jelentkezz be sz\u00e1m\u00edt\u00f3g\u00e9pen."},{I:"div",S:"ytp-mdx-privacy-popup-buttons",
V:[{I:"button",La:["ytp-button","ytp-mdx-privacy-popup-cancel"],ya:"M\u00e9gse"},{I:"button",La:["ytp-button","ytp-mdx-privacy-popup-confirm"],ya:"Meger\u0151s\u00edt\u00e9s"}]}]}]});this.j=new g.CG(this,250);this.cancelButton=this.Ga("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Ga("ytp-mdx-privacy-popup-confirm");g.N(this,this.j);this.T(this.cancelButton,"click",this.B);this.T(this.confirmButton,"click",this.C)},m$=function(a){g.V.call(this,{I:"div",
S:"ytp-remote",V:[{I:"div",S:"ytp-remote-display-status",V:[{I:"div",S:"ytp-remote-display-status-icon",V:[g.twa()]},{I:"div",S:"ytp-remote-display-status-text",ya:"{{statustext}}"}]}]});this.api=a;this.j=new g.CG(this,250);g.N(this,this.j);this.T(a,"presentingplayerstatechange",this.onStateChange);this.Hc(a.Xb())},n$=function(a,b){g.NX.call(this,"Lej\u00e1tsz\u00e1s itt:",1,a,b);
...
this.Kp={key:Yzb(),name:"Ezen a sz\u00e1m\u00edt\u00f3g\u00e9pen"};this.Sl=null;this.subscriptions=[];this.ZQ=this.Kc=null;this.Tt=[this.Kp];this.Es=this.Kp;this.Le=new g.wL(64);this.rY=0;this.Vh=-1;this.fF=!1;this.dF=this.ZA=null;if(!g.aS(this.player.U())&&!g.$G(this.player.U())){a=this.player;var b=g.cU(a);b&&(b=b.zp())&&(b=new n$(a,b),g.N(this,b));b=new m$(a);g.N(this,b);g.oU(a,b.element,4);this.ZA=new l$;g.N(this,this.ZA);g.oU(a,this.ZA.element,4);this.fF=!!c$()}},o$=function(a){a.dF&&(a.player.removeEventListener("presentingplayerstatechange",
...
this.Rc(I9(a));break;case -1:this.Gc(new g.wL(64));break;case -1E3:this.Gc(new g.wL(128,{errorCode:"mdx.remoteerror",errorMessage:"Ezt a vide\u00f3t nem lehet t\u00e1volr\u00f3l lej\u00e1tszani.",KH:2}))}a=M9(this.Kc).trackData;var b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.C=a,rEb(this,a));a=M9(this.Kc);-1===a.volume||Math.round(this.J.getVolume())===a.volume&&this.J.isMuted()===a.muted||this.Z.isActive()||
this.d1()}else pEb(this)};
...
m$.prototype.Hc=function(a){if(3===this.api.getPresentingPlayerType()){var b={RECEIVER_NAME:this.api.getOption("remote","currentReceiver").name};a=g.JG(a,128)?g.aK("Hiba a k\u00f6vetkez\u0151ben: $RECEIVER_NAME",b):a.isPlaying()||a.isPaused()?g.aK("Lej\u00e1tsz\u00e1s a k\u00f6vetkez\u0151n: $RECEIVER_NAME",b):g.aK("Kapcsol\u00f3d\u00e1s ide: $RECEIVER_NAME",b);this.updateValue("statustext",a);this.j.show()}else this.j.hide()};g.w(n$,g.NX);n$.prototype.D=function(){var a=this.J.getOption("remote","receivers");a&&1<a.length&&!this.J.getOption("remote","quickCast")?(this.Tt=g.cc(a,this.j,this),g.OX(this,g.Er(a,this.j)),a=this.J.getOption("remote","currentReceiver"),a=this.j(a),this.options[a]&&this.Qj(a),this.enable(!0)):this.enable(!1)};
n$.prototype.j=function(a){return a.key};
n$.prototype.Kk=function(a){return"cast-selector-receiver"===a?"\u00c1tk\u00fcld\u00e9s...":this.Tt[a].name};
